...
class DefaultConverter(Converter):
    ...
    def handle_nopinyin(
        self, chars: Text, style: TStyle, heteronym: bool, errors: TErrors, strict: bool, **kwargs: Any
    ) -> TPinyinResult: ...
    def post_handle_nopinyin(
        self, chars: Text, style: Style, heteronym: bool, errors: TErrors, strict: bool, pinyin: TNoPinyinResult, **kwargs: Any
    ) -> TNoPinyinResult: ...
    def post_pinyin(self, han: Text, heteronym: bool, pinyin: TPinyinResult, **kwargs: Any) -> Union[TPinyinResult, None]: ...
    def convert_styles(
        self,
        pinyin_list: TPinyinResult,
        phrase: Text,
        style: TStyle,
        heteronym: bool,
        errors: TErrors,
    ...
    def _phrase_pinyin(self, phrase: Text, style: TStyle, heteronym: bool, errors: TErrors, strict: bool) -> TPinyinResult: ...
    def _single_pinyin(self, han: Text, style: TStyle, heteronym: bool, errors: TErrors, strict: bool) -> TPinyinResult: ...
    def _convert_style(self, han: Text, pinyin: Text, style: TStyle, strict: bool, default: Text, **kwargs: Any) -> Text: ...
    def _convert_nopinyin_chars(self, chars: Text, style: TStyle, heteronym: bool, errors: TErrors, strict: bool) -> TNoPinyinResult: ...
