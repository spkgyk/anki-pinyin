...
class Timeout:
    ...
    def _validate_timeout(cls, value: _TYPE_TIMEOUT, name: str) -> _TYPE_TIMEOUT:
        ...
        try:
            ...
            raise ValueError("Timeout value %s was %s, but it must be an " "int, float or None." % (name, value)) from None
    ...
    def read_timeout(self) -> float | None:
        ...
        """
        if self.total is not None and self.total is not _DEFAULT_TIMEOUT and self._read is not None and self._read is not _DEFAULT_TIMEOUT:
