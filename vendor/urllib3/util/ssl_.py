...
def create_urllib3_context(
    ...
    if ssl_version not in (None, PROTOCOL_TLS, PROTOCOL_TLS_CLIENT):
        ...
        # 'ssl_version' is deprecated and will be removed in the future.
            ...
            warnings.warn(
                "'ssl_version' option is deprecated and will be " "removed in urllib3 v2.1.0. Instead use 'ssl_minimum_version'",
    ...
    if cert_reqs == ssl.CERT_REQUIRED and getattr(context, "post_handshake_auth", None) is not None:
